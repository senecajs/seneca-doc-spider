export default {
  ...
  calls: [
    ...
    // Validate that all filespider/entry exists and are correct
    {
    ...
    // Validate that all filespider/occur exists and are correct
    {
    ...
    // Validate new filespider/occur records
    {
      pattern: 'biz:null,role:entity,base:filespider,name:occur,cmd:list',
    ...
    // Validate new all filespider/reward updated
    {
      pattern: 'biz:null,role:entity,base:filespider,name:reward,cmd:list',
      out: [
        {
          entry_id: '`create-multiple:out.entry.id`',
          entry_kind: 'standard',
